...
function svc(domain: string, service: string, target?: Target, data?: Record<string, unknown>): Action {
  return { type: 'ha.call_service', domain, service, ...(target && { target }), ...(data && { data }) };
}
...
export const HomeAssistant = {
  ...
  light: {
    turn_on:  (target: Target, data?: LightTurnOnData): Action => svc('light', 'turn_on',  target, data as Record<string, unknown>),
    turn_off: (target: Target, data?: { transition?: number }): Action => svc('light', 'turn_off', target, data as Record<string, unknown>),
    toggle:   (target: Target, data?: LightTurnOnData): Action => svc('light', 'toggle',   target, data as Record<string, unknown>),
  },
  ...
  fan: {
    turn_on:       (target: Target, data?: { percentage?: number; preset_mode?: string }): Action => svc('fan', 'turn_on', target, data as Record<string, unknown>),
  ...
  lock: {
    lock:   (target: Target, data?: AlarmCode): Action => svc('lock', 'lock',   target, data as Record<string, unknown>),
    unlock: (target: Target, data?: AlarmCode): Action => svc('lock', 'unlock', target, data as Record<string, unknown>),
    open:   (target: Target, data?: AlarmCode): Action => svc('lock', 'open',   target, data as Record<string, unknown>),
  },

  climate: {
    turn_on:         (target: Target): Action => svc('climate', 'turn_on',          target),
    turn_off:        (target: Target): Action => svc('climate', 'turn_off',         target),
    set_hvac_mode:   (target: Target, data: { hvac_mode: HvacMode }): Action => svc('climate', 'set_hvac_mode',   target, data as Record<string, unknown>),
    set_temperature: (target: Target, data: ClimateSetTemperatureData): Action => svc('climate', 'set_temperature', target, data as Record<string, unknown>),
  ...
  media_player: {
    ...
    volume_mute:         (target: Target, data: { is_volume_muted: boolean }): Action => svc('media_player', 'volume_mute', target, data as Record<string, unknown>),
    select_source:       (target: Target, data: { source: string }): Action => svc('media_player', 'select_source', target, data),
    shuffle_set:         (target: Target, data: { shuffle: boolean }): Action => svc('media_player', 'shuffle_set',  target, data as Record<string, unknown>),
    repeat_set:          (target: Target, data: { repeat: MediaPlayerRepeat }): Action => svc('media_player', 'repeat_set',  target, data),
    play_media:          (target: Target, data: MediaPlayerPlayMediaData): Action => svc('media_player', 'play_media',  target, data as Record<string, unknown>),
  },

  alarm_control_panel: {
    arm_away:     (target: Target, data?: AlarmCode): Action => svc('alarm_control_panel', 'arm_away',     target, data as Record<string, unknown>),
    arm_home:     (target: Target, data?: AlarmCode): Action => svc('alarm_control_panel', 'arm_home',     target, data as Record<string, unknown>),
    arm_night:    (target: Target, data?: AlarmCode): Action => svc('alarm_control_panel', 'arm_night',    target, data as Record<string, unknown>),
    arm_vacation: (target: Target, data?: AlarmCode): Action => svc('alarm_control_panel', 'arm_vacation', target, data as Record<string, unknown>),
    disarm:       (target: Target, data?: AlarmCode): Action => svc('alarm_control_panel', 'disarm',       target, data as Record<string, unknown>),
    trigger:      (target: Target, data?: AlarmCode): Action => svc('alarm_control_panel', 'trigger',      target, data as Record<string, unknown>),
  },

  scene: {
    turn_on: (target: Target, data?: { transition?: number }): Action => svc('scene', 'turn_on', target, data as Record<string, unknown>),
  },
  ...
  input_select: {
    ...
    set_options:   (target: Target, data: { options: string[] }): Action => svc('input_select', 'set_options', target, data as Record<string, unknown>),
  },
